...
<c:url value="/resources/${product.productid}.jpg" var="imageurl">
 <div class="register">
 <h3>Add Category</h3>
 <br>
 <p> <label><b>Product Name : </b></label><form:input type="text" path="productname" value="${productdata.productname}" required="true"/></p><br>  
  ...
  <p> <label><b>Product Image : </b></label><img src="${imageurl}" height="50" width="50" value="${productdata.productid}"></p><br> 
