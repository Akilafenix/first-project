  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
       ...
       <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="product">Product <span class="caret"></span></a>
        ...
        <li><a href="category"><span class="glyphicon glyphicon-user"></span>Category</a></li>
            <li><a href="supplier"><span class="glyphicon glyphicon-user"></span>Supplier</a></li>
